...
PoseOptimization::PoseOptimization(const PoseOptimizationOption& option)
    : options_(option),
      pose_motion_filter_(new jarvis::MotionFilter(MotionFilterOptions{1000,0.1,0.4})),
      rtk_motion_filter_(new jarvis::MotionFilter(MotionFilterOptions{1000,0.1,0.4})) {}

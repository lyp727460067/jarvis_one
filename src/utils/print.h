 ...
 */
#define PRINT_ALL(x...) local_pose_provider::Printer::debugPrint(local_pose_provider::Printer::PrintLevel::ALL, __FILE__, TOSTRING(__LINE__), x);
#define PRINT_DEBUG(x...) local_pose_provider::Printer::debugPrint(local_pose_provider::Printer::PrintLevel::DEBUG, __FILE__, TOSTRING(__LINE__), x);
#define PRINT_INFO(x...) local_pose_provider::Printer::debugPrint(local_pose_provider::Printer::PrintLevel::INFO, __FILE__, TOSTRING(__LINE__), x);
#define PRINT_WARNING(x...) local_pose_provider::Printer::debugPrint(local_pose_provider::Printer::PrintLevel::WARNING, __FILE__, TOSTRING(__LINE__), x);
#define PRINT_ERROR(x...) local_pose_provider::Printer::debugPrint(local_pose_provider::Printer::PrintLevel::ERROR, __FILE__, TOSTRING(__LINE__), x);

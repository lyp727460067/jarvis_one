#ifndef JARVIS_ESTIMATION_FACTOR_INITIAL_FACTOR_H
#define JARVIS_ESTIMATION_FACTOR_INITIAL_FACTOR_H
...
namespace jarvis {
namespace estimator {
class InitialPoseFactor : public ceres::SizedCostFunction<3, 7> {
 public:
  InitialPoseFactor(const float weight, const Eigen::Vector3d &_P, const Eigen::Quaterniond &_Q) {
    init_P = _P;
    init_Q = _Q;
    sqrt_info = weight * Eigen::Matrix<double, 3, 3>::Identity();
  }

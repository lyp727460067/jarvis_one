...
CameraPtr CameraFactory::GenerateCameraFromOption(const CameraOption& options) {
  ...
  if (options.camera_model == "pinhole" &&
    ...
    LOG(INFO) << options.resolution.x() << " " << options.resolution.y() << " "
              << options.distortions[0] << " " << options.distortions[1] << " "
              << options.distortions[2] << " " << options.distortions[3] << " "
              << options.intrinsics[0] << " " << options.intrinsics[1] << " "
              << options.intrinsics[2] << " " << options.intrinsics[3];

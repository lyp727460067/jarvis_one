  ...
  ZMSSD(uint8_t* ref_patch) : ref_patch_(ref_patch) {
    ...
    if (patch_size_ == 0) {
      ...
      for (int i = 0; i < 64; i += 8) {
        ...
        sumAAx4 =
            vmlal_u16(sumAAx4, vget_low_u16(tpl_x8), vget_low_u16(tpl_x8));
        sumAAx4 =
            vmlal_u16(sumAAx4, vget_high_u16(tpl_x8), vget_high_u16(tpl_x8));
      }
      uint16x4_t sumAx4 =
  ...
  int computeScore(uint8_t* cur_patch, int stride) const {
    ...
    if (patch_size_ == 8) {
      ...
      for (int i = 0; i < 64; i += 8, cur_ptr += stride, ref_ptr += 8) {
        ...
        // multiply and sum
        sumBBx4 =
            vmlal_u16(sumBBx4, vget_low_u16(img_x8), vget_low_u16(img_x8));
        sumBBx4 =
            vmlal_u16(sumBBx4, vget_high_u16(img_x8), vget_high_u16(img_x8));
        // multiply and sum
        sumABx4 =
            vmlal_u16(sumABx4, vget_low_u16(tpl_x8), vget_low_u16(img_x8));
        sumABx4 =
            vmlal_u16(sumABx4, vget_high_u16(tpl_x8), vget_high_u16(img_x8));
      }
      uint16x4_t sumBx4 =
